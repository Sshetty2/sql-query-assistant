...
class State(TypedDict):
    ...
    pre_plan_strategy: Optional[str]  # Text-based strategic plan generated by pre-planner (initial queries only)
    revised_strategy: Optional[str]  # Revised strategy from error/refinement corrections (bypasses pre-planner)
    ...
    termination_reason: Optional[str]  # Reason for termination (error message or explanation)
